...
0.25 & 0.11 & 0.17 & 0.0275 & 0.0425 \\

0.25 & 0.13 & 0.3 & 0.0325 & 0.075 \\
...
Предметы роскоши & 7 & 4 \\

Нормальные блага & 8 & 28 \\

Товары первой необходимости & 85 & 68 \\
\bottomrule
\end{tabularx}
\label{task4}
\end{minipage} \\[35pt]
...
\item Линейных коэффициент <<абсолютных>> структурных сдвигов за период 2018--2022,
\item Квадратический коэффициент <<абсолютных>> структурных сдвигов за период 2020--2022.\medskip
\end{enumerate}
...
\toprule
 & \textbf{2018, \%} & \textbf{2020, \%} & \textbf{2022, \%} \\
\cmidrule(lr){2-2}\cmidrule(lr){3-3}\cmidrule(lr){4-4}
Менеджеры & 9.4 & 2.2 & 1.2 \\

Высококвалифицированные кадры & 9.1 & 29.5 & 30.4 \\

Рабочие & 81.5 & 68.3 & 68.4 \\
\bottomrule
\end{tabularx}
\label{task3}
\end{minipage} \\[35pt]

\textbf{Задача 4 (2 б.).} В таблице \ref{task10} представлены данные о прибылях филиалов А, Б и В некоторой фирмы. Рассчитайте обобщающий показатель централизации (индекс Герфиндаля-Хиршмана) и проинтерпретируйте результат. Ответ округлите до четырёх знаков после запятой\\
