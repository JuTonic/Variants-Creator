...
\textbf{Задача 1 (4 б.).} В таблице \ref{task4} представлена структура потребления товаров разных категорий для населений городов А и Б. Пользуясь этими данными, рассчитайте и проинтерпретируйте индекс Рябцева. Ответ округлите до четырёх знаков после запятой.\\
...
Предметы роскоши & 5 & 3 \\

Нормальные блага & 6 & 12 \\

Товары первой необходимости & 89 & 85 \\
\bottomrule
\end{tabularx}
\label{task4}
\end{minipage} \\[35pt]
...
0.25 & 0.11 & 0.2 & 0.0275 & 0.05 \\

0.25 & 0.19 & 0.39 & 0.0475 & 0.0975 \\

0.25 & 0.61 & 1.0 & 0.1525 & 0.25 \\
\addlinespace
\textit{Всего:} & -- & -- & \textit{0.25} & \textit{0.42} \\
\bottomrule
\end{tabularx}
\label{task7}
\end{minipage} \\[35pt]
...
\item Квадратический коэффициент <<относительных>> структурных сдвигов за период 2021--2022,
\item Линейных коэффициент <<абсолютных>> структурных сдвигов за период 2020--2022.\medskip
\end{enumerate}
...
Нефтегазовые доходы & 41.9 & 43.4 & 49.2 \\

Налоги на прибыль и доходы & 48.6 & 48.0 & 46.0 \\
